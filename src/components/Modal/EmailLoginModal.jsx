...
function EmailLoginModal({ closeEmailLoginModal, openRegisModalEmail }) {
  ...
  const handleClickSubmitEmail = async () => {
    try {
      startLoading();
      ...
      // closeEmailLoginModal();
      // openRegisModalEmail();
      // toastError('cannot found your email, please register');
    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-gray-900 bg-opacity-50 z-50 leading-5'>
      <div className='flex flex-col justify-center items-center h-full'>
        <div className='relative w-[568px] h-[4rem] px-6 bg-white rounded-t-xl flex justify-center items-center font-extrabold text-base'>
          <i
            className='absolute left-6 fa-solid fa-xmark rounded-full text-lg '
        ...
        <div className='w-[568px] h-[600px] px-6 bg-white rounded-b-xl flex flex-col'>
          ...
          <div>
            <button
              ...
              onClick={handleClickSubmitEmail}
            >
              Continue
            </button>
